...
namespace lchhieu\Cassandra\Eloquent;

use Carbon\Carbon;
use DateTime;
use Illuminate\Database\Eloquent\Model as BaseModel;
use Illuminate\Database\Eloquent\Relations\Relation;
use lchhieu\Cassandra\Query\Builder as QueryBuilder;
use lchhieu\Cassandra\Relations\EmbedsMany;
use lchhieu\Cassandra\Relations\EmbedsOne;
use lchhieu\Cassandra\Relations\EmbedsOneOrMany;
...
abstract class Model extends BaseModel
{
     ...
     * @return \lchhieu\Cassandra\Relations\EmbedsMany
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $relation
     * @return \lchhieu\Cassandra\Relations\EmbedsOne
     */
     ...
     *
     * @param  \lchhieu\Cassandra\Query\Builder $query
     * @return \lchhieu\Cassandra\Eloquent\Builder|static
     */
