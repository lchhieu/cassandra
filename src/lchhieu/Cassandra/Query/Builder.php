...
namespace lchhieu\Cassandra\Query;
...
use lchhieu\Cassandra\Connection;
...
class Builder extends BaseBuilder
{
    ...
    public function getFresh($columns = [])
    {
        ...
        // Drop all columns if * is present, Cassandra does not work this way.
        ...
        // Use Cassandra's aggregation framework when using grouping or aggregation functions.
    ...
    {
        // Execute the closure on the cassandra collection
        ...
        // Quick access to the cassandra collection
